...
interface RepresentantesTableProps {
  ...
  onEditRepresentante: (id: string) => void;
...
export function RepresentantesTable({ representantes, onViewRepresentacoes, onEditRepresentante, onTagsChange }: RepresentantesTableProps) {
              ...
              >
                ...
                <TableCell className="py-4 px-4 md:px-6">
                  <div className="flex items-center gap-2">
                    ...
                    <TagsManager
                      tags={representante.tags || []}
                      onTagsChange={(tags) => onTagsChange(representante.id, tags)}
                    />
                  </div>
                </TableCell>
                <TableCell className="py-4 px-4 md:px-6">
